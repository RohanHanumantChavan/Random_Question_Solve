...
Output : 
Odd Elements of First Array is :
9       5       3

Output :
Odd Elements of Second Array is :
45       23      
  
*/                
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//   Application Name : Write Program java Program Accept Two Array From User And Display Odd Elements of that Array
//                        
//    Input : Integer
//    Output : Integer
...
class ArrayX
{
   ...
   System.out.println("Elements of First Array is : ");
    ...
    System.out.println();
     ...
     System.out.println("Odd Elements of First Array is : ");
     for(int iCnt = 0; iCnt < Arr1.length; iCnt++)
    {
        if((Arr1[iCnt] % 2) != 0)
        {
     ...
     System.out.println("Odd Elements of Second Array is : ");
    for(int iCnt = 0; iCnt < Arr2.length; iCnt++)
    {
        if((Arr2[iCnt] % 2) != 0)
        {
